...
export default function Home() {
  ...
  return (
    <main className="flex flex-col bg-cyan-500 text-black" >
      ...
      <div className="max-w-7xl mt-16 flex flex-col items-center justify-center mx-auto -mt-[20px]">
        ...
        <Card name={"Mariam"} Id={188224} day={"Monday 2pm - 5pm"} /><br/>
        <Card name={"Nimra"} Id={166548} day={"Monday 2pm - 5pm"} /><br/>
        <Card name={"Yusra"} Id={166548} day={"Monday 2pm - 5pm"} /><br/>
        <Card name={"Huzaifa"} Id={166548} day={"Monday 2pm - 5pm"} /><br/>
      </div>
    </main>
  );
}